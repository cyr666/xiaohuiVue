	...
	<div class = "linecharts">
		<el-row class="table-header" style="padding-bottom:0">
			<el-col :span="24" align="left">
				<el-col :span='4' style="margin-left:15px;line-height: 63px;">聊天统计</el-col>								   					    
		...
		<div id="echartContainer" style="width:970px; height:350px"></div> <!--创建一个echarts的容器-->
	</div>
</template>
...
export default {
	...
	data(){
			return{
				...
				serviceY:[220, 182, 191, 234, 290, 330, 310, 132, 101, 134, 90, 230, 210],
				startTime:'',
				endTime:'',
				isDay:true,
				isWeek:false,
	  ...
	  methods: {
	  	...
	  	handleGetHomeDataSucc(res){
	  		...
	  		if(res.data.code == 404){
	  			...
	  			var Xarr = res.data.element.xDate;
	  			var Xdata = []
